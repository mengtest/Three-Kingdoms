...
public class UITexture : UIBasicSprite
{
	...
	protected bool mCreatingMat = false;
	protected Material mDynamicMat = null;
	...
	public override Material material
	{
		get
		{
			...
			if (!mCreatingMat && mDynamicMat == null)
			{
				...
				mDynamicMat.SetFloat("_Grey", _enable ? 0 : 1);
				mPMA = 0;
				mCreatingMat = false;
			}
			return mDynamicMat;
	...
	[HideInInspector][SerializeField] protected bool _enable = true;
	public virtual bool isEnabled
	{
		...
		set
		{
			if (_enable != value)
			{
				...
				if (material != null) 
				{
					material.SetFloat("_Grey", _enable ? 0 : 1);
				}
				RemoveFromPanel();
				MarkAsChanged();
			}
